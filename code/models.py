...
class SpGAT(nn.Module):
    def __init__(self, num_nodes, num_relation, nfeat, nhid, relation_dim, dropout, alpha, nheads):
        """
        ...
        self.attentions = [SpGraphAttentionLayer(num_nodes, num_relation,
                                                 nfeat,
                                                 nhid,
                                                 relation_dim,
                                                 dropout=dropout,
        ...
        self.out_att = SpGraphAttentionLayer(num_nodes, num_relation,
                                             nhid * nheads,
                                             nheads * nhid,
                                             nheads * nhid,
                                             dropout=dropout,
...
#    def forward(self, input, edge, edge_embed, edge_list_nhop, edge_embed_nhop):
        ...
        edge_embed_nhop = out_relation_1[
            edge_type_nhop[:, 0]] + out_relation_1[edge_type_nhop[:, 1]] + torch.selu(h_t_hdm_n)
...
class SpKBGATModified(nn.Module):
    def __init__(self, initial_entity_emb, initial_relation_emb, entity_out_dim, relation_out_dim,
        ...
        self.sparse_gat_1 = SpGAT(self.num_nodes, self.num_relation, self.entity_in_dim, self.entity_out_dim_1, self.relation_dim,
    ...
    def forward(self, Corpus_, adj, batch_inputs, train_indices_nhop):
        ...
        #del edge_list, edge_type, edge_list_nhop, edge_type_nhop, entities_upgraded
        #torch.cuda.empty_cache()
